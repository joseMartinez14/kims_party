...
export const datalist = [
    ...
    {
        condition: '(Grupal) Los que no le dijeron feliz cumpleaños a Kim el propio día del cumpleaños',
        action: 'Toman 1 shot (manda huevo)',
        type: 'Random',
        answer: '',
    },
    {
        condition: '(Pregunta individual / Sobre Kim) Como se llama la mamá de kim?',
    ...
    {
        condition: '(Pregunta individual / Sobre Kim) Cuál película ve Kim para dormir después de ver una película de miedo?',
        action: 'Si contesta correctamente reparte 4 tragos si no se los toma',
        type: 'Question',
        answer: 'Shrek',
    },
    ...
    {
        condition: '(Pregunta individual / Sobre Kim) Como se llama el papá de kim?',
        action: 'Si contesta correctamente reparte 4 tragos si no se los toma',
        type: 'Question',
        answer: 'Christian',
    },
