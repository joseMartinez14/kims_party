export const photolist = [
  ...
  "https://special-cards-s3-bucket.s3.us-east-2.amazonaws.com/messageImages/WhatsApp+Image+2023-10-10+at+16.52.22.jpeg",
  "https://special-cards-s3-bucket.s3.us-east-2.amazonaws.com/messageImages/WhatsApp+Image+2023-10-12+at+18.17.02.jpeg", //Kim con Manrri
  "https://special-cards-s3-bucket.s3.us-east-2.amazonaws.com/messageImages/WhatsApp+Image+2023-10-12+at+23.38.50.jpeg", // Lucho y polk foto borrosa y graciosa
  "https://special-cards-s3-bucket.s3.us-east-2.amazonaws.com/messageImages/WhatsApp+Image+2023-10-14+at+10.20.51.jpeg", // Cata y jhoan
  "https://special-cards-s3-bucket.s3.us-east-2.amazonaws.com/messageImages/WhatsApp+Image+2023-10-14+at+10.21.49.jpeg", // Cata y jhoan
...
export const datalist = [
  ...
  {
    condition:
      "(Grupal) Los que no le dijeron feliz cumpleaños a Kim el propio día del cumpleaños",
  ...
  {
    condition:
      "(Pregunta individual / Sobre Kim) Como se llama la mamá de kim?",
  ...
  {
    condition:
      "(Pregunta individual / Sobre Kim) En que temporada fue kim a Work and Travel?",
  ...
  {
    condition:
      "(Pregunta individual / Sobre Kim) Como se llama la perrita de kim",
    action: "Si contesta correctamente reparte 3 tragos si no se los toma",
    type: "Question",
    answer: "Samy",
  },
  ...
  {
    condition:
      "(Pregunta individual / Sobre Kim) Cuál película ve Kim para dormir después de ver una película de miedo?",
    action: "Si contesta correctamente reparte 4 tragos si no se los toma",
    type: "Question",
    answer: "Shrek",
  },
  {
    condition: "(Pregunta individual / Sobre Kim) En donde trabaja kim?",
    action: "Si contesta correctamente reparte 4 tragos si no se los toma",
    type: "Question",
    answer: "Intel",
  },
  {
    condition: "(Pregunta individual / Sobre Kim) Que está estudiando Kim?",
    action: "Si contesta correctamente reparte 4 tragos si no se los toma",
    type: "Question",
    answer: "Administración de empresas.",
  },
  {
    condition:
      "(Pregunta individual / Sobre Kim) Como se llama el papá de kim?",
    action: "Si contesta correctamente reparte 4 tragos si no se los toma",
    type: "Question",
    answer: "Christian",
  },
  {
    condition: "(Pregunta individual / Sobre Kim) A que escuela fue Kim?",
    action: "Si contesta correctamente reparte 6 tragos si no se toma 3",
    type: "Question",
    answer: "Escuela Moya",
  },
  {
    condition: "(Reto) Meta la jupa en la piscina",
    action: "Si lo hace reparte 2 shots si no toma 1",
    type: "Random",
    answer: "",
  },
  {
  ...
  {
    condition:
      "(Reto) Enseñe la galeria de fotos de su telefono en la parte de escondidos",
  ...
  {
    condition: "Los que son exnovios de Kim",
    action: "No toman nada. No son bienvenidos, vayanse. HPS",
    type: "",
    answer: "",
  },
  {
    condition: "(Grupal) Si les cae mal kim",
    action: "Reparte 1 trago si no se toman 3",
    type: "",
    answer: "",
  },
  {
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Quién escribió La Odisea?",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Quién pintó “la última cena”?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Qué año llegó Cristóbal Colón a América?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
    answer: "1492",
  },
  {
    condition:
      "(Pregunta individual / cultura general) ¿Quién ha protagonizado la saga de Indiana Jones?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿En qué año murió Freddie Mercury?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
    answer: "1991",
  },
  {
    condition:
      "(Pregunta individual / cultura general) ¿Cuándo empezó la Primera Guerra Mundial?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
    answer: "En 1914",
  },
  {
    condition:
      '(Pregunta individual / cultura general) "Ser o no ser, esa es la cuestión". ¿De qué libro es esta cita?',
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Quién es el padre del psicoanálisis?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Cuál es el disco más vendido de la historia?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿En qué lugar del cuerpo se produce la insulina?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Con qué se fabricaba el pergamino?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Pregunta individual / cultura general) ¿Dónde está la Casa Blanca?",
    action: "Si responde bien, reparte 4 tragos, si no se toma 4",
    type: "Question",
  ...
  {
    condition:
      "(Reto) Propóngale matrimonio a la persona de la derecha, lo más convincente posible",
    action:
      "Los demás deciden, si fue convincente reparte 5 tragos si no se toma 3",
    type: "",
    answer: "",
  },
];
...
const calientes = [
  "Dejeme chuparle un pezon",
  "Dejeme tomarle un nude yo decido como tiene que posar",
  "Pongame un nude suyo de fondo de pantalla en mi celular",
  "Quisete una prenda",
  "Mencione 3 buenos recuerdos que tenemos juntos",
  "Tomese un trago de algo y yo puedo intentar 3 veces que se ría",
  "Enséñeme un nude y yo voy a intentar dibujarlo",
  "En qué momento ha sentido apoyo emocional de mi parte",
  "Escriban una carta juntos con fecha de hoy. Guárdenla y léanla en unos meses cuando se acuerden",
];
